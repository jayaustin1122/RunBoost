package com.example.athlitecsapp.ui.dashboard.twoHundredFocus
...
import com.example.athlitecsapp.databinding.FragmentListsTwoHundredBinding
...
class ListsTwoHundredFragment : Fragment() {
    private lateinit var binding : FragmentListsTwoHundredBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentListsTwoHundredBinding.inflate(layoutInflater)
        // Inflate the layout for this fragment
        return binding.root
    }
    override fun onSaveInstanceState(outState: Bundle) {
        super.onSaveInstanceState(outState)
        outState.putInt("CURRENT_VIDEO_INDEX6", currentPosition)
    }
    private fun saveCurrentPositionToPrefs() {
        val sharedPreferences = requireContext().getSharedPreferences("VideoPrefs6", Context.MODE_PRIVATE)
        val editor = sharedPreferences.edit()
        editor.putInt("CURRENT_VIDEO_INDEX6", currentPosition)
        editor.apply() // Save the value asynchronously
    }
    private fun getCurrentPositionFromPrefs(): Int {
        val sharedPreferences = requireContext().getSharedPreferences("VideoPrefs6", Context.MODE_PRIVATE)
        return sharedPreferences.getInt("CURRENT_VIDEO_INDEX6", 0)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        currentPosition = savedInstanceState?.getInt("CURRENT_VIDEO_INDEX6") ?: getCurrentPositionFromPrefs()
