...
import com.example.athlitecsapp.databinding.FragmentTakeTwoHundredBinding
...
class TakeTwoHundredFragment : Fragment() {
    private lateinit var binding: FragmentTakeTwoHundredBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTakeTwoHundredBinding.inflate(layoutInflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.statusLiveData.observe(viewLifecycleOwner) { status ->
            if (status != null) {
                ...
                val progress = status.level5DayProgress
                    ...
                    DialogUtils.showWarningMessage(
                        ...
                        confirmListener = SweetAlertDialog.OnSweetClickListener { dialog ->
                            val bundle = Bundle().apply {
                                putInt("day", status.level5DayProgress)
                                putString("level", level)
                                putString("scope", "200m")
                            }
                            ...
                            if (status.level5DayProgress >= 31) {
                                ...
                                DialogUtils.showWarningMessage(
                                    ...
                                    confirmListener = SweetAlertDialog.OnSweetClickListener { resetDialog ->
                                        ...
                                        viewModel.updateLevel5(1)
                                        findNavController().navigate(R.id.listsTwoHundredFragment, resetBundle)
                                ...
                                findNavController().navigate(R.id.listsTwoHundredFragment, bundle)
