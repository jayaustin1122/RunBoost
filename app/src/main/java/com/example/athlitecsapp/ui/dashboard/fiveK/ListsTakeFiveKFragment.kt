...
import com.example.athlitecsapp.databinding.FragmentListsTakeFiveKBinding
...
class ListsTakeFiveKFragment : Fragment() {
    private lateinit var binding : FragmentListsTakeFiveKBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentListsTakeFiveKBinding.inflate(layoutInflater)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putInt("CURRENT_VIDEO_INDEX3", currentPosition)
    }
    private fun saveCurrentPositionToPrefs() {
        val sharedPreferences = requireContext().getSharedPreferences("VideoPrefs3", Context.MODE_PRIVATE)
        val editor = sharedPreferences.edit()
        editor.putInt("CURRENT_VIDEO_INDEX3", currentPosition)
        editor.apply() // Save the value asynchronously
    }
    private fun getCurrentPositionFromPrefs(): Int {
        val sharedPreferences = requireContext().getSharedPreferences("VideoPrefs3", Context.MODE_PRIVATE)
        return sharedPreferences.getInt("CURRENT_VIDEO_INDEX3", 0)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        currentPosition = savedInstanceState?.getInt("CURRENT_VIDEO_INDEX3") ?: getCurrentPositionFromPrefs()
        ...
        binding.btnSkip.setOnClickListener {
            try {
                day++
                signUpviewModel.updateLevel4(day)
                findNavController().navigateUp()
            } catch (e: Exception) {
